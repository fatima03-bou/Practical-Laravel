        ...
        <form method="POST" action="{{ route('admin.categorie.update', ['id' => $viewData['categorie']->id]) }}">
          ...
          <div class="mb-4">
            ...
            <div class="input-group rounded-3 shadow-sm">
              ...
              <input name="name" value="{{ $viewData['categorie']->name }}" type="text" class="form-control rounded-3 border-start-0" placeholder="Enter category name">
            </div>
          </div>
          <div class="mb-4">
            ...
            <div class="input-group rounded-3 shadow-sm">
              ...
              <textarea name="description" rows="3" class="form-control rounded-3 border-start-0" placeholder="Enter category description">{{ $viewData['categorie']->description }}</textarea>
            </div>
          </div>
